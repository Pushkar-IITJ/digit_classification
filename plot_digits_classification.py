...
from utils import preprocess_data, split_data, train_model, read_digits, predict_and_eval, train_test_dev_split, get_hyperparameter_combinations, tune_hparams, preprocess_unit_normalization, train_and_evaluate_lr
...
X_train_normalized, X_test_normalized = preprocess_unit_normalization(X_train, X_test)
train_and_evaluate_lr(X_train_normalized, y_train, X_test_normalized, y_test, roll_no="M22AIE213")
